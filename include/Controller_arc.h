...
SC_MODULE(Controller){
  ...
  enum State{
    sIdle, sMovingBias, sSettingBias, sMovingWeight, sSettingWeight, sMovingIntput, sGeneratingOutput, sMovingOutput
  }
  ...
  /* Boundary Registers */
  uint32_t u32InputWidthBoundary,
           u32OutputChannelBoundary,
  /* Indexing Registers */
           u32InputWidthIndex,
           u32InputHeightIndex,
           u32OutputWidthIndex,
  ...
  /* DMAC Clear Signal */
           cu32ClearDMACAddr = 0x20 + DMAC_BASE,
           cu32ClearDMACData = 1,
  ...
  bool bComponentAvailable[NUM_SRAM + 1], bOutputDataReq, bWaitingForDMAC, bWaitingForController;
