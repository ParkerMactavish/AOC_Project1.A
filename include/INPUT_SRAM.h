#ifndef _INPUT_SRAM_H
#define _INPUT_SRAM_H
...
DECLARE_EXTENDED_PHASE(ISRAM_InternalPhase);

using namespace std;
using namespace tlm;
using namespace tlm_utils;

struct ISRAM : ::sc_core::sc_module{
  peq_with_cb_and_phase<ISRAM> m_peq;
  uint32_t *u32Mem,
           u32BaseAddr,
           u32MemSize;
  /* Socket Conneted to DMAC */
  simple_target_socket<ISRAM> sktFromDMAC, sktFromController;
  ...
  typedef ISRAM SC_CURRENT_USER_MODULE;
  ISRAM(
  ...
  , m_peq(this, &ISRAM::peq_cb){
    // Register callbacks for incoming interface method calls
    sktFromDMAC.register_nb_transport_fw(this, &ISRAM::nb_transport_fw);
    sktFromController.register_nb_transport_fw(this, &ISRAM::nb_transport_fw);
